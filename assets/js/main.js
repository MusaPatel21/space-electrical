                    ...
                    e(this).on("click", function (s) {
                        ...
                        s.preventDefault(),
                            ...
                            e(o).next("ul").length > 0
                                ? (e(o).parent().toggleClass(t.subMenuParentToggle),
                                  e(o).next("ul").slideToggle(t.toggleSpeed),
                                  e(o).next("ul").toggleClass(t.subMenuToggleClass))
                                : e(o).prev("ul").length > 0 &&
                                  (e(o).parent().toggleClass(t.subMenuParentToggle),
                                  e(o).prev("ul").slideToggle(t.toggleSpeed),
                                  e(o).prev("ul").toggleClass(t.subMenuToggleClass));
                    });
                }),
    ...
    e(window).on("scroll", function () {
        ...
        (o = e(".sticky-active")),
            ...
            (r = o.css("height")),
            o.parent().css("min-height", r),
            e(window).scrollTop() > 800
                ? (o.parent().addClass(n), i > s ? o.removeClass(a) : o.addClass(a))
                : (o.parent().css("min-height", "").removeClass(n), o.removeClass(a)),
            (s = i),
            e(this).scrollTop() > 500 ? e(t).addClass("show") : e(t).removeClass("show");
    }),
        e(t).each(function () {
            e(this).on("click", function (t) {
                return t.preventDefault(), e("html, body").animate({ scrollTop: 0 }, s / 3), !1;
            });
        }),
        ...
        e(".vs-3d-slider")
            .on("init", function (s, t, o) {
                var a = e(t.$slides[t.currentSlide]),
                    n = a.next().next(),
                    i = a.next(),
                    r = a.prev(),
                    l = a.prev().prev();
                n.addClass("vs-slick-nextto"),
                    i.addClass("vs-slick-next"),
                    a.removeClass("vs-slick-next").removeClass("vs-slick-nextto"),
                    a.removeClass("vs-slick-prev").removeClass("vs-slick-prevto"),
                    l.addClass("vs-slick-prevto"),
            ...
            .on("beforeChange", function (s, t, o, a) {
                var n = e(t.$slides[a]),
                    i = n.next(),
                    r = n.next().next(),
                    l = n.prev();
                (prevto = n.prev().prev()),
                    t.$prevto.removeClass("vs-slick-prevto"),
                    t.$prev.removeClass("vs-slick-prev"),
                    t.$next.removeClass("vs-slick-next"),
                    t.$nextto.removeClass("vs-slick-nextto"),
                    r.addClass("vs-slick-nextto"),
                    i.addClass("vs-slick-next"),
                    n.removeClass("vs-slick-next").removeClass("vs-slick-nextto"),
                    n.removeClass("vs-slick-prev").removeClass("vs-slick-prevto"),
                    l.addClass("vs-slick-prev"),
                    prevto.addClass("vs-slick-prevto"),
                    (t.$prev = l),
                    (t.$prevto = prevto),
                    (t.$next = i),
                    (t.$nextto = r);
        ...
        e(".vs-carousel").each(function () {
            ...
            e("[data-slick-next]").each(function () {
                ...
                1 == t("arrows") &&
                    (s.closest(".arrow-wrap").length || s.closest(".container").parent().addClass("arrow-wrap")),
                s.slick({
                    dots: !!t("dots"),
                    fade: !!t("fade"),
                    arrows: !!t("arrows"),
        ...
        (s = (function () {
            ...
            function o(o) {
                ...
                for (var a = 0; a < o.length; a++)
                    (s = i + " " + o[a]), e(s).val() ? (e(s).removeClass(r), (t = !0)) : (e(s).addClass(r), (t = !1));
            }
            o(c),
                e(l).val() &&
                e(l)
                    ...
                    .fail(function (e) {
                        d.removeClass("success"),
                            ...
                            "" !== e.responseText
                                ...
                                : d.html("Oops! An error occured and your message could not be sent.");
                    });
    }
    e(i).on("submit", function (e) {
        ...
        e(".filter-active").imagesLoaded(function () {
            ...
            if (e(s).length > 0) {
                var o = e(s).isotope({ itemSelector: ".filter-item", filter: "*", masonry: { columnWidth: 1 } });
        ...
        e(".sideMenuToggler").on("click", function (s) {
            s.preventDefault(), e(o).addClass(n);
        }),
        e(o).on("click", function (s) {
            s.stopPropagation(), e(o).removeClass(n);
        }),
        e(o + " > div").on("click", function (s) {
            s.stopPropagation(), e(o).addClass(n);
        }),
        e(a).on("click", function (s) {
            s.preventDefault(), s.stopPropagation(), e(o).removeClass(n);
        });
    let u = e(".gallery-style3 .gallery-item");
    u &&
        u.each(function () {
        ...
        (e.fn.vsslideTab = function () {
            e(this).each(function () {
                let s = e(this),
                    ...
                    a = 0;
                o.each(function () {
                    e(this).attr("data-slide-togo", a),
                        e(this).on("click", function () {
                            let s = e(this).data("slide-togo");
                            e(this).addClass("active").siblings(".active").removeClass("active"),
                                e(t).slick("slickGoTo", s);
                        }),
                        a++;
                });
            });
        }),
        e(".vs-slider-tab").vsslideTab(),
        e(".service-slider-one").slick({
            arrows: !1,
            dots: !1,
            infinite: !0,
            speed: 1e3,
            ...
            slidesToScroll: 1,
            fade: !0,
            asNavFor: ".service-slider-two",
        }),
        e(".service-slider-two").slick({
            dots: !1,
            arrows: !0,
            vertical: !0,
            infinite: !0,
        ...
        e(".ticker-slide").eocjsNewsticker({ speed: 40, timeout: 1, divider: "", type: "static" }),
        ...
        (function (s, t, o, a) {
            e(t).on("click", function (t) {
                t.preventDefault(), e(s).addClass(a);
            }),
                e(s).on("click", function (t) {
                    t.stopPropagation(), e(s).removeClass(a);
                }),
                e(s)
                    .find("form")
                    .on("click", function (t) {
                        t.stopPropagation(), e(s).addClass(a);
                    }),
                e(o).on("click", function (t) {
                    t.preventDefault(), t.stopPropagation(), e(s).removeClass(a);
                });
